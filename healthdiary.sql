...
--
-- Host: localhost
-- Generation Time: Apr 06, 2016 at 03:32 PM
...
--
-- Table structure for table `healthdiary`
--
...
--
-- Dumping data for table `healthdiary`
--

INSERT INTO `healthdiary` (`when_where`, `event`, `emotion`, `auto_thoughts`, `rational_response`) VALUES
('example1', 'example1', 'example1', 'example1', 'example1'),
('example1', 'example1', 'example1', 'example1', 'example1'),
('example1example1', 'example1', 'example1example1', 'example1example1', 'example1example1'),
